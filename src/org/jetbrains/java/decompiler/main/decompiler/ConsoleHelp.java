...
public class ConsoleHelp {
  private static final String[] DEFAULT_HELP = {
    "=== Cleanflower Decompiler " + ConsoleDecompiler.version() + " ===",
    "",
    ...
    "",
    "--- Decompiler usage ---",
    "Usage: java -jar cleanflower.jar --<option>=<value>... <source>... <destination>",
  ...
  static void printPlugins() {
    System.out.println("=== Cleanflower Decompiler " + ConsoleDecompiler.version() + " ===");
    System.out.println();
